...
<h2 class="btn-primary" style="width:100%"; id="cronometro">00:00:00</h2>
     ...
     <br />
       ...
       <br />
         ...
         <button id="btn_iniciar" class="btn-primary w-100" type="button" onclick="startTimer()">INICIAR TRABALHO</button>
    ...
    <script>
        ...
        function setupCanvas(signature) {
            ...
            function draw(event, canvas, ctx) {
                ...
                ctx.lineTo((event.clientX - rect.left-50)/3.5, event.clientY - rect.top);
                ctx.stroke();
                ctx.beginPath();
                ctx.moveTo((event.clientX - rect.left-50)/3.5, event.clientY - rect.top);
            }
        }
